...
/**
 * Main class for the Jeara web application.
 */
public class WebMain {
    ...
    public static void main(String[] args) throws URISyntaxException {
        if (args.length == 0) {
            ...
            logger.info("expected URI format: postgresql://user:password@localhost/jeara");
        ...
        JearaServer server = new JearaServer(source, http);
